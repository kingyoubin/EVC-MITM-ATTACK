...
class EVSE:
    ...
    def __init__(self, args):
        ...
        self.sourceMAC = args.source_mac[0] if args.source_mac else "00:1e:c0:f2:6c:a3"
        self.sourceIP = args.source_ip[0] if args.source_ip else "fe80::21e:c0ff:fef2:6ca3"
...
class _SLACHandler:
    ...
    def buildAttenCharInd(self):
        ...
        attens = [0] * 58  # 신호 감쇄 값을 모두 0으로 설정
        groups = []
        for e in attens:
            g = HPGP_GROUP()
            g.group = e
